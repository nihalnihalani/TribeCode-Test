...
6. Keep it short and crispy (strictly under 140 characters). CRITICAL: Write a COMPLETE sentence that ends naturally. Do NOT generate incomplete or cut-off sentences. The reply must be a full, coherent thought that finishes properly.
